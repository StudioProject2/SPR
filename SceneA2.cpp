...
void SceneA2::Init()
{
	...
	monster1BulletTime = elaspeTime + 5.0;
	monster2BulletTime = elaspeTime + 5.0;
	monster3BulletTime = elaspeTime + 5.0;
	monster4BulletTime = elaspeTime + 5.0;
	monster5BulletTime = elaspeTime + 5.0;
	monster6BulletTime = elaspeTime + 5.0;
	monster7BulletTime = elaspeTime + 5.0;
	monster8BulletTime = elaspeTime + 5.0;
	monster9BulletTime = elaspeTime + 5.0;
	monster10BulletTime = elaspeTime + 5.0;
...
void SceneA2::UpdateMonsterBullets()
{
	...
	if (elaspeTime > monster1BulletTime && MonsterPtr[0] != NULL)
	{
		for (int i = 0; i < MOBBULLETNUM; i++)
		{
	...
	if (elaspeTime > monster2BulletTime && MonsterPtr[1] != NULL)
	{
		for (int i = 0; i < MOBBULLETNUM; i++)
		{
			if (monsterBulletPtr[i] == NULL)
	...
	if (elaspeTime > monster3BulletTime && MonsterPtr[2] != NULL)
	{
		for (int i = 0; i < MOBBULLETNUM; i++)
		{
			if (monsterBulletPtr[i] == NULL)
	...
	if (elaspeTime > monster4BulletTime  && MonsterPtr[3] != NULL)
	{
		for (int i = 0; i < MOBBULLETNUM; i++)
		{
			if (monsterBulletPtr[i] == NULL)
	...
	if (elaspeTime > monster5BulletTime && MonsterPtr[4] != NULL)
	{
		for (int i = 0; i < MOBBULLETNUM; i++)
		{
			if (monsterBulletPtr[i] == NULL)
	...
	if (elaspeTime > monster6BulletTime && MonsterPtr[5] != NULL)
	{
		for (int i = 0; i < MOBBULLETNUM; i++)
		{
			if (monsterBulletPtr[i] == NULL)
			{
				monsterBulletPtr[i] = new monsterBullet(MonsterPtr[5], camera.position);
				monster6BulletTime = elaspeTime + 4.0;
				return;
			}
		}
	}

	if (elaspeTime > monster7BulletTime && MonsterPtr[6] != NULL)
	{
		for (int i = 0; i < MOBBULLETNUM; i++)
		{
			if (monsterBulletPtr[i] == NULL)
			{
				monsterBulletPtr[i] = new monsterBullet(MonsterPtr[6], camera.position);
				monster7BulletTime = elaspeTime + 4.0;
				return;
			}
		}
	}

	if (elaspeTime > monster8BulletTime && MonsterPtr[7] != NULL)
	{
		for (int i = 0; i < MOBBULLETNUM; i++)
		{
			if (monsterBulletPtr[i] == NULL)
			{
				monsterBulletPtr[i] = new monsterBullet(MonsterPtr[7], camera.position);
				monster8BulletTime = elaspeTime + 4.0;
				return;
			}
		}
	}

	if (elaspeTime > monster9BulletTime && MonsterPtr[8] != NULL)
	{
		for (int i = 0; i < MOBBULLETNUM; i++)
		{
			if (monsterBulletPtr[i] == NULL)
			{
				monsterBulletPtr[i] = new monsterBullet(MonsterPtr[8], camera.position);
				monster9BulletTime = elaspeTime + 4.0;
				return;
			}
		}
	}

	if (elaspeTime > monster10BulletTime && MonsterPtr[9] != NULL)
	{
		for (int i = 0; i < MOBBULLETNUM; i++)
		{
			if (monsterBulletPtr[i] == NULL)
			{
				monsterBulletPtr[i] = new monsterBullet(MonsterPtr[9], camera.position);
				monster10BulletTime = elaspeTime + 4.0;
				return;
			}
		}
	}
